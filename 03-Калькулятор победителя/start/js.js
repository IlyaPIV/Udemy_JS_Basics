...
ЗАДАЧА:
    ...
    В этой функции создайте вариацию условий, которые помогут определить победителя с помощью if/ else if
    и вывести сообщение с результатом в консоль.
...
const fn = (res1, res2, res3) => (res1 + res2 + res3) / 3;

// const avgFirst = fn(44, 23 ,71);
// const avgSecond = fn(65, 54, 49);

const avgFirst = fn(85, 54 ,41);
const avgSecond = fn(23, 34, 27);


function checkWinner(result1, result2){
    console.log(`Результат первой команды: ${result1}`);
    console.log(`Результат второй команды: ${result2}`);

    if (result1 > result2 * 2) {
        console.log("Победа первой команды");
    } else if (result1 * 2 < result2) {
        console.log("Победа второй команды")
    } else console.log("Ничья");
}

checkWinner(avgFirst, avgSecond);